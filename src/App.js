...
function App() {
  ...
  useEffect(()=>{
    document.title = `Counter stands at ${count}`
  ...
  return (
        <>
          ...
          style={{ height:"50px", width:"50px"}} onClick={toggleLight}
          alt="flashlight"/>
          ...
          <p>You are currently <strong>{networkStatus ? 'Online':'Offline'}</strong></p>
